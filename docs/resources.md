...
|----------|-------------|------|
| Codeforces | Main platform for daily practice and virtual contests | [codeforces.com](https://codeforces.com/) |
| CSES Problem Set | Primary source for structured algorithm practice | [cses.fi/problemset](https://cses.fi/problemset/) |
| Codeforces Gym | Past ACPC and ICPC-style team contests | [codeforces.com/gym](https://codeforces.com/gym) |
| Assiut Newcomers | Beginner-friendly extra practice by topic (join required) | [CF Group](https://codeforces.com/group/MWSDmqGsZm/contests) |
